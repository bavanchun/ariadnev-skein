            ...
            Toggle("Always-hidden section can be shown", isOn: manager.bindings.canToggleAlwaysHiddenSection)
                .annotation {
                    if appState.settingsManager.generalSettingsManager.showOnClick {
                        Text("Option + click one of Frost's menu bar items, or inside an empty area of the menu bar to show the section")
                    } else {
                        Text("Option + click one of Frost's menu bar items to show the section")
                    }
                }
        }
    }
